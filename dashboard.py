...
def financial_summary(symbol: str):
    ...
    Berdasarkan data keuangan kuartalan (dalam miliar rupiah) berikut:  
    {data}
...
def revenue_trend(symbol: str, financials: pd.DataFrame):
    ...
    Anda adalah seorang data visual consultant yang handal dengan skill pemrogramman python.
